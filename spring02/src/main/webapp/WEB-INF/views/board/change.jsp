...
<body>
	...
	<form name="form1" method="post">
		...
		<div>タイトル:<textarea name="title" id="title" rows="1.5" cols="100" placeholder="タイトルを入力してください。">${dto.title}</textarea></div>
		<div>内 容 :<textarea name="content" id="content" rows="25" cols="100" placeholder="内容を入力してください。">${dto.content} </textarea></div>
		<div>作 成 者 : ${dto.writer}</div>
		<div>修 正 者 :<textarea name="upd_id" id="upd_id" rows="1.5" cols="100" placeholder="修正者を入力してください。">${dto.upd_id}</textarea></div>
		<p>
